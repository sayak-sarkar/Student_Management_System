      ...
      <tr>
        <td align="left" valign="top"><form id="form1" name="form1" method="post" action="">
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              <td height="25" colspan="2" align="left" valign="middle"><span class="style15">Department of Chemistry</span></td>
            </tr>
            <tr>
            ...
            <tr>
              <td height="25" colspan="2" align="left" valign="middle"> <span class="style15">Faculty </span></td>
            </tr>
            <tr>
              <td height="10" colspan="2">&nbsp;</td>
            </tr>
            <tr>
              <td width="48%" align="left" valign="top"><p class="style19">Dr. Sanjib Kumar Bhar ( M.Sc., Ph.D. )</p>
                <p class="style16">&nbsp;</p>
                <p class="style16"> Senior Lecturer</p>
                <p class="style16">&nbsp;</p>
                <p class="style19">Dr. Bidyut Kumar Chowdhury ( M.Sc., Ph.D. )</p>
                <p class="style19">&nbsp;</p>
                <p class="style16">Reader</p>
                <p class="style16">&nbsp;</p>
                <p class="style19">Dr. (Smt.) Surasree Chowdhury ( M.Sc., Ph.D. )</p>
                <p class="style19">&nbsp;</p>
                <p class="style16">Reader</p>
                <p class="style16">&nbsp;</p>
                <p class="style19">Shri Dipankar Mukherjee ( M.Sc. )</p>
                <p class="style16">&nbsp;</p>
                <p class="style16">Lecturer ( Part-Time )</p></td>
              <td width="52%" align="left" valign="top"><p class="style19"> Dr. Ratan Kumar Kar ( M.Sc., Ph.D. )</p>
                <p class="style19">&nbsp;</p>
                <p class="style16">Reader</p>
                <p class="style16">&nbsp;</p>
                <p class="style19">Dr. Ramjan Mondal ( M.Sc., Ph.D. )</p>
                <p class="style19">&nbsp;</p>
                <p class="style16">Reader</p>
                <p class="style16">&nbsp;</p>
                <p class="style19">Shri Sambhunath Nandi ( M.Sc. )</p>
                <p class="style19">&nbsp;</p>
                <p class="style16">Selection Grade Lecturer &amp; Head of the Department</p>
            ...
            <tr>
              <td height="25" align="left" valign="middle"><span class="style15">Laboratory Instructor </span></td>
              <td align="left" valign="top">&nbsp;</td>
            </tr>
            <tr>
              <td align="left" valign="top">&nbsp;</td>
            ...
            <tr>
              <td align="left" valign="top" class="style19"><p>Shri Manoj Chakraborty ( B.Sc. )</p>
                <p>&nbsp;</p>
                <p>Shri Maurari Mondal ( B.Sc. Hons )</p></td>
              <td align="left" valign="top">&nbsp;</td>
            </tr>
            <tr>
              <td align="left" valign="top">&nbsp;</td>
            ...
            <tr>
              <td align="left" valign="top" class="style16"><p class="style19">Shri Debashish Chatterjee ( B.A. )</p>
                <p>&nbsp;</p>
                <p>Store Keeper                </p>
                <p>&nbsp;</p>
                <p class="style19">Shri Durjadhan Naskar </p>
                <p>&nbsp;</p>
                <p>Laboratory Attendant</p>
                <p>&nbsp;</p>
                <p class="style19">Shri Ranjit Dewan</p>
                <p>&nbsp;</p>
                <p>Laboratory Attendant</p>
                <p>&nbsp;</p>
                <p class="style19">Shri Dilip Mallick</p>
                <p>&nbsp;</p>
                <p>Laboratory Attendant</p>
                </td>
              <td align="left" valign="top"><p class="style19">Shri Moloy Kumar Das</p>
                <p class="style19">&nbsp;</p>
                <p class="style16">Store Keeper</p>
                <p class="style16">&nbsp;</p>
                <p class="style19">Shri Prasanta Kumar Barui</p>
                <p class="style16">&nbsp;</p>
                <p class="style16">Store Keeper</p>
                <p class="style16">&nbsp;</p>
                <p class="style19">Shri Priya Ghosh</p>
                <p class="style16">&nbsp;</p>
                <p class="style16">Store Keeper</p>
                <p class="style16">&nbsp;</p>
                <p class="style19">Shri Nainigopal Dey</p>
                <p class="style16">&nbsp;</p>
                <p class="style16">Store Keeper</p></td>
            </tr>
