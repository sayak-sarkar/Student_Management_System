<%
	...
	set rs2=cn.execute("insert into temp5 values('"& listno &"')")
	set rs2=cn.execute("select * from temp5")

	set rs=cn.execute("select * from form,marksobtained where form.studid=marksobtained.studid and form.formaccepted=1 order by marksobtained.normtotal")
        ...
        <td align="left" valign="top"><form id="form1" name="form" method="post" action="">
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              ...
              <td height="10" align="left" valign="middle"><div align="center" class="style22">List number 
                <label>
                <input name="listno" type="text" id="listno" size="4" maxlength="4" value="<%=rs2.fields("studid")%>" onclick="this.blur()"/>
                </label>
              </div></td>
              <td height="10" align="left" valign="middle">&nbsp;</td>
              <td height="10" align="left" valign="middle">&nbsp;</td>
