...
function sure()
{
  ...
  {
    alert("Please enter the quota and click show button below again");
    form.quota.focus();
  }
}
      ...
      <tr>
        <td align="left" valign="top"><form id="form1" name="form" method="post" action="">
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              <td width="23%" height="25" align="left" valign="middle"><div align="right"></div></td>
            ...
            <tr>
              <td align="left" valign="middle">&nbsp;</td>
              <td height="25" align="left" valign="middle"><div align="center"><span class="style15">Quota</span></div></td>
              <td colspan="4" align="left" valign="middle"><div align="left">
                <select name="quota">
                  <option value="0">---------------------------SELECT------------------------</option>
            ...
            <tr>
              ...
              <td width="16%" height="25" align="left" valign="middle"><div align="left" class="style22">
                <div align="center">Student Id</div>
              </div></td>
              <td width="9%" height="25" align="left" valign="middle"><div align="center" class="style22">Course</div></td>
            ...
            <tr>
              ...
              <td height="10" align="left" valign="top">&nbsp;</td>
              <td height="10" align="left" valign="top">&nbsp;</td>
              <td width="5%" height="10" align="left" valign="top"><div align="left" class="style32"><a href="../pages/quota-wise admission.asp">Prev</a></div></td>
              <td width="25%" align="left" valign="top"><div align="left" class="style32"><a href="../pages/quota-wise admission.asp">Next</a></div></td>
            </tr>
            <tr>
