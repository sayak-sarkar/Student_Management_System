<%
	...
	set rs=cn.execute("delete from temp5")
	set rs=cn.execute("insert into temp5 values('"& studid &"')")
...
function sure2()
{
    if(navigator.appName=="Microsoft Internet Explorer")
     {
       window.open('../index.asp','_parent');      //javascript to open html page in same tab
       //window.close();
        ...
        <td align="left" valign="top"><form id="form1" name="form" method="post" action="">
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              ...
              <td height="10" align="left" valign="middle">&nbsp;</td>
              <td height="10" align="left" valign="middle">&nbsp;</td>
              <td height="10" colspan="2" align="left" valign="middle" class="style25">&nbsp;</td>
              <td height="10" align="left" valign="middle">&nbsp;</td>
              <td height="10" align="left" valign="middle">&nbsp;</td>
              <td height="10" align="left" valign="middle">&nbsp;</td>
              <td height="10" align="left" valign="middle">&nbsp;</td>
            ...
            <tr>
              ...
              <td height="10" align="left" valign="middle">&nbsp;</td>
              <td height="10" align="left" valign="middle">&nbsp;</td>
              <td height="10" colspan="2" align="left" valign="middle" class="style25">STUDENT ID</td>
              <td height="10" align="left" valign="middle">&nbsp;</td>
              <td height="10" align="left" valign="middle"><label>
                <input name="studid" type="text" id="studid" size="10" maxlength="10" value="<%=rs.fields("studid")%>" onclick="this.blur()" />
              </label></td>
              <td height="10" align="left" valign="middle">&nbsp;</td>
              <td height="10" align="left" valign="middle">&nbsp;</td>
              <td height="10" align="left" valign="middle">&nbsp;</td>
            ...
            <tr>
              ...
              <td width="129" height="10" align="left" valign="middle"><div align="center" class="style28">
                <div align="left"></div>
              </div></td>
            ...
            <tr>
              ...
              <td width="32" height="10" align="left" valign="middle"><div align="center" class="style25"></div></td>
            ...
            <tr>
              ...
              <td width="40" align="left" valign="middle"><div align="left"></div></td>
              ...
              <td width="9" height="10" align="left" valign="middle"><div align="center"></div></td>
            ...
            <tr>
              ...
              <td width="80" height="10" align="left" valign="middle">&nbsp;</td>
              <td height="10" align="left" valign="middle">&nbsp;</td>
              <td height="10" align="left" valign="middle">&nbsp;</td>
              <td height="10" colspan="2" align="left" valign="middle">&nbsp;</td>
              <td height="10" colspan="2" align="left" valign="middle">&nbsp;</td>
              <td width="18" height="10" align="left" valign="middle">&nbsp;</td>
              <td height="10" align="left" valign="middle">&nbsp;</td>
              <td height="10" align="left" valign="middle">&nbsp;</td>
              <td height="10" colspan="2" align="left" valign="top">&nbsp;</td>
              <td height="10" align="left" valign="top">&nbsp;</td>
            ...
            <tr>
              ...
              <td width="14" align="left" valign="middle"><div align="left" class="style25"></div></td>
              <td height="10" align="left" valign="middle"><div align="left"></div></td>
            ...
            <tr>
              ...
              <td width="26" height="10" align="left" valign="middle"><div align="left"></div></td>
              <td width="63" height="10" align="left" valign="middle"><div align="left"></div></td>
              <td height="10" align="left" valign="middle"><div align="left"></div></td>
              <td width="49" height="10" align="left" valign="middle"><div align="left" class="style25"></div></td>
              <td height="10" colspan="3" align="left" valign="middle"><div align="left" class="style25">
                <div align="center"></div>
              </div></td>
            ...
            <tr>
              ...
              <td height="10" align="left" valign="top" class="style60">&nbsp;</td>
              <td height="10" align="left" valign="top" class="style60">&nbsp;</td>
              <td width="16" height="10" align="left" valign="top" class="style60">&nbsp;</td>
              <td width="140" height="10" align="left" valign="top" class="style60">&nbsp;</td>
              <td height="10" align="left" valign="top" class="style60">&nbsp;</td>
              <td height="25" colspan="2" align="left" valign="top" class="style60"><div align="center">
                <label></label>
                <label>
                
                  
                    <div align="right">
                      <input type="button" name="PRINT" id="YES" value="PRINT" onclick="window.print()"/>
                    </div>
                    </label>
              </div>
                <div align="right"></div><div align="right"></div><div align="right"></div><div align="right"></div></td>
              <td height="25" colspan="2" align="left" valign="middle" class="style60">
                <div align="right">
                  <input type="button" name="SAVE" id="YES2" value="SAVE" onclick="sure()"/>
                </div></td>
              <td height="10" colspan="3" align="left" valign="top" class="style60">
                <div align="right"></div>
                <div align="center">
                  <input type="button" name="HOME" id="HOME" value="HOME" onclick="sure2()"/>
                </div></td>
