<%
	...
	set rs=cn.execute("select * from dd where dd.ddaccepted=1")
    ...
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
		...
		%>
            ...
            <tr>
              <td height="25" colspan="4" align="left" valign="middle"><div align="center" class="style22">Those students whose demand draft are accepted are been displayed....</div></td>
            </tr>
            <tr>
              <td colspan="4" align="left" valign="top">&nbsp;</td>
            </tr>
