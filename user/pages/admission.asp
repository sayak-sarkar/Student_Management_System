<%
	...
	set rs=cn.execute("select * from admit where admitted=1")
%>
		...
		<ul class="menu">
			...
			<li><a href="#"><span>Reports</span></a>
				<div><ul>
					...
					<li><a href="../pages/available seats.asp"><span>Seats</span></a></li>
      ...
      <tr>
		...
		%>	
              <td height="10" align="left" valign="top"><div align="center"><span class="style31">
                ...
                <input name="studid" type="text" size="10" maxlength="10" value="<%=rs.fields("studid")%>" onfocus="this.blur()" id="studid1"/>
		    </span></div></td>
			<td width="37%" colspan="2" align="left" valign="middle">&nbsp;</td>
                  </tr>
		<td height="10" align="left" valign="top"><div align="center"><span class="style31">
