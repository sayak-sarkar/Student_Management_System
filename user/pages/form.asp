<%
	option explicit
	dim cn,rs1,rs2,rs3,rs4,studid,transid,ddnumber,dddate,ddamount,formdate,cast,branchname,branchcode,ddaccepted,day,month,year,formno,formaccepted
	...
	set rs1=cn.execute("select * from dd")
	...
	while not rs1.eof = true
      ...
      studid=cint(studid)
	formno=studid+1
      studid=100000+studid
	transid=request.form("transid")
	cast=request.form("cast")
	ddnumber=request.form("draftno")
	ddamount=request.form("amount")
	...
	set rs2=cn.execute("delete from temp")
	set rs2=cn.execute("insert into dd values('"& studid &"','"& transid &"','"& ddnumber &"','"& dddate &"','"& ddamount &"','"& formdate &"','"& branchname &"','"& branchcode &"','"& ddaccepted &"')")
	set rs3=cn.execute("insert into form values('"& studid &"','"& formno &"','"& formaccepted &"')")
	set rs4=cn.execute("insert into temp values('"& studid &"','"& formno &"')")
...
function hons()
{
  if(form.hs.value==0)
  {
    document.getElementById("gsc3").style.visibility="visible";
  }
  else
  {
      document.getElementById("gsc3").style.visibility="hidden";
  }
...
function fncsubmit()
{
	...
	else if(form.additional.value=="")
	{
		alert("Please enter the additional subject")
		form.additonal.focus();
		return;
	}
	else if(form.additionaltheory.value=="")
	{
		alert("Please enter the additional subject theory marks")
		form.additionaltheory.focus();
		return;
	}
      else if(form.elective1prac.value=="")
	{
		form.elective1prac.value=0;
      }
	else if(form.elective2prac.value=="")
	{
		form.elective2prac.value=0;
	}
      else if(form.elective3prac.value=="")
	{
		form.elective3prac.value=0;
	}
	form.submit();
...
<table width="960" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        <td align="left" valign="top"><form id="form1" name="form" method="post" action="../pages/demo.asp">
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              ...
              <td height="10" colspan="12" align="left" valign="middle" class="style34"><select name="hs" id="FormsComboBox4" onChange="hons();">
                  ...
                  <option value="JOURNALISM &amp; MASS COMM">JOURNALISM &amp; MASS COMMUNICATION</option>
            ...
            <tr>
              ...
              <td height="10" colspan="20" align="left" valign="middle" class="style34">
                <select id="gsc2" name="gsc2">
                  ...
                  <option value="ECONOMICS">ECONOMICS</option>
                  <option value="SANSKRIT">SANSKRIT</option>
                  <option value="JOURNALISM &amp; MASS COMMU">JOURNALISM &amp; MASS COMMUNICATION</option>
                  <option value="BOTANY">BOTANY</option>
                  <option value="PHILOSOPHY">PHILOSOPHY</option>
                  <option value="ENVIRONMENTAL SCIENCE">ENVIRONMENTAL SCIENCE</option>
                  <option value="ZOOLOGY">ZOOLOGY</option>
            ...
            <tr>
              ...
              <td height="10" align="left" valign="middle"><div align="left"><font size="-1" face="Arial,Helvetica,Geneva,Sans-serif,sans-serif"><b>
                <input id="FormsRadioButton12" type="radio" name="nb" value="WBCHSE" />
              </b></font></div></td>
              ...
              <td align="left" valign="middle"><font size="-1" face="Arial,Helvetica,Geneva,Sans-serif,sans-serif"><b>
                <input id="FormsRadioButton2" type="radio" name="nb" value="CBSE" />
              </b></font></td>
              ...
              <td colspan="2" align="left" valign="middle"><div align="left" class="style25"><font size="-1" face="Arial,Helvetica,Geneva,Sans-serif,sans-serif"><b>
                <input id="FormsRadioButton3" type="radio" name="nb" value="ISC" />
              </b></font></div></td>
            ...
            <tr>
              ...
              <td height="10" colspan="4" align="left" valign="middle" class="style60"><div align="left">
                  <div align="left">
                    <input name="mn" type="text" id="mn" size="15" maxlength="15" onkeypress="if (event.keyCode &gt;=48 &amp;&amp; event.keyCode &lt;=57) event.returnValue = true; else event.returnValue = false"/>
                  </div>
              </div></td>
            ...
            <tr>
              ...
              <td height="10" colspan="11" align="left" valign="middle" class="style60"><div align="left">
                <input name="gname" type="text" size="50" maxlength="50" onkeypress="if (event.keyCode &gt;=48 &amp;&amp; event.keyCode &lt;=57) event.returnValue = false"/>
              </div></td>
              <td height="10" align="left" valign="middle" class="style60">&nbsp;</td>
              <td height="10" align="left" valign="middle" class="style60">&nbsp;</td>
            ...
            <tr>
              ...
              <td height="10" colspan="3" align="left" valign="middle" class="style60"><div align="left">
                <input name="lang1" type="text" id="lang1" onkeypress="if (event.keyCode &gt;=48 &amp;&amp; event.keyCode &lt;=57) event.returnValue = false" size="15" maxlength="15" />
              </div></td>
              <td height="10" colspan="3" align="left" valign="middle" class="style60"><div align="left" class="style25">
            ...
            <tr>
              <td height="25" colspan="29" align="left" valign="middle" class="style60"><div align="center" class="style23">FIELDS IN (<span class="style24">*</span>) ARE MANDATORY. IF YOU DON'T HAVE PRACTICAL MARKS THEN ENTER ZERO IN PRACTICAL MARKS FIELDS</div></td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td height="10" align="left" valign="top" class="style60">&nbsp;</td>
              <td height="25" colspan="2" align="left" valign="middle" class="style60"><div align="center">
                <label>
                <input type="button" name="SUBMIT" id="SUBMIT" value="SUBMIT" onclick="fncsubmit()"/>
                </label>
              </div></td>
              <td height="10" align="left" valign="top" class="style60">&nbsp;</td>
              <td height="10" colspan="2" align="left" valign="top" class="style60">&nbsp;</td>
              <td height="10" colspan="2" align="left" valign="middle" class="style60"><div align="center">
                <label>
                <input type="button" name="RESET" id="RESET" value="RESET" onclick="fncreset()"/>
                </label>
              </div></td>
              <td height="10" align="left" valign="top" class="style60">&nbsp;</td>
              <td height="10" colspan="2" align="left" valign="top" class="style60">&nbsp;</td>
