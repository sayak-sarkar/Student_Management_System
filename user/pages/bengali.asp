      ...
      <tr>
        <td align="left" valign="top"><form id="form1" name="form1" method="post" action="">
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              <td height="25" colspan="2" align="left" valign="middle"><span class="style15">Department of Bengali </span></td>
            </tr>
            <tr>
              <td height="10" colspan="2" align="left" valign="top">&nbsp;</td>
            </tr>
            <tr>
              <td colspan="2" align="left" valign="top"><span class="style16"><strong>Departmental Teacher’s Staffs</strong> :<br />
                Out of four whole time teachers of the department, two have Ph.D. and One has M.Phil. Degree.<br />
                One teacher is a registered Ph.D. Researcher in Calcutta University.<br />
                One part-time teacher who has Ph.D. Degree from Calcutta university. </span></td>
            </tr>
            <tr>
            ...
            <tr>
              <td width="44%" align="left" valign="top"><p class="style16"> <strong>Subrata Samanta</strong>, M.A., M.Phil. </p>
                <p class="style16">&nbsp;</p>
                <p class="style16"> Associate Professor </p>
                <p class="style16"> Ph. No. 24670574 </p>
                <p class="style16">&nbsp;</p>
                <p class="style16"> <strong>Nabakishor Chanda</strong>, M.A. </p>
                <p class="style16">&nbsp;</p>
                <p class="style16"> Assistant Professor  </p>
                <p class="style16"> Ph. No. 24300417 </p>
                <p class="style16"> <strong>Research Interest</strong> </p>
                <p class="style16"> Painting, Rabindranath Tagore’s fine arts. </p>
                <p class="style16"> <strong>N.B.</strong> : Professor N.K. Chanda is internationally famous armature painter. </p>
                <p class="style16"> Part-Time Lecturer </p>
                <p class="style16"> Ph. No. 9434231139 </p></td>
              <td width="56%" align="left" valign="top"><p> <span class="style16"><strong>Dr. Pranati Chakraborty</strong>, M.A., Ph.D. </span></p>
                <p class="style16">&nbsp;</p>
                <p class="style16"> Associate Professor </p>
                <p class="style16"> Ph. No. 23293223 </p>
                <p class="style16"> <strong>Research Interest</strong> </p>
                <p class="style16"> Literature, Cinema and Drama </p>
                <p class="style16">&nbsp;</p>
                <p class="style16"> <strong>Ratna Ghosh</strong>, M.A., Ph.D. </p>
                <p class="style16">&nbsp;</p>
                <p class="style16"> Associate Professor and Head of the Dept. </p>
                <p class="style16"> Ph. No. 24610629 </p>
                <p class="style16"> <strong>Research Interest</strong> </p>
                <p class="style16"> Kamrupi Dialect, The language and Culture of the Tribal people of North East. </p></td>
            </tr>
            <tr>
