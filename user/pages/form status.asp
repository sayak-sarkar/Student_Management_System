<%
	...
	set rs=cn.execute("select * from form where form.formaccepted=1")
    ...
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
			...
			<li><a href="#"><span>Reports</span></a>
				<div><ul>
					...
					<li><a href="#"><span>Students</span></a>
						<div><ul>
							<li><a href="../pages/rejected students"><span>Rejected Students</span></a></li>
      ...
      <tr>
		...
		%>
            ...
            <tr>
              <td height="25" colspan="4" align="left" valign="middle"><div align="center" class="style22">Those students whose forms are accepted are been displayed....</div></td>
            </tr>
            <tr>
              <td colspan="4" align="left" valign="top">&nbsp;</td>
            </tr>
