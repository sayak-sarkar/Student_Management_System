<%
	...
	set rs=cn.execute("select * from date1")
%>
        ...
        <td align="left" valign="top"><form id="form1" name="form" method="post" action="">
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              ...
              <td width="38%" height="25" align="left" valign="middle"><div align="left"><span class="style15">Forms are available from</span></div></td>
              <td width="5%" height="25" align="left" valign="middle">&nbsp;</td>
              <td width="37%" align="left" valign="middle">                <div align="left">
                <input name="startdate" type="text" id="startdate" size="30" maxlength="30" value="<%=rs.fields("startdate")%>" onfocus="this.blur()"/>              
              </div></td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td height="25" align="left" valign="middle"><div align="left">
                <input name="lastdate" type="text" id="lastdate" size="30" maxlength="30" value="<%=rs.fields("endate")%>" onfocus="this.blur()"/>
              </div></td>
            </tr>
