      ...
      <tr>
        <td align="left" valign="top"><form id="form1" name="form1" method="post" action="">
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              <td height="25" colspan="2" align="left" valign="middle"><span class="style15">Department of Sanskrit</span></td>
            </tr>
            <tr>
              <td height="10" colspan="2" align="left" valign="top">&nbsp;</td>
            </tr>
            <tr>
              <td colspan="2" align="left" valign="top"> <span class="style16">Our Sanskrit department is a very old one.  This department was served by very well known teachers. The relation between teachers and student are very cordial.  Department produces many good students.  Among them we glad to mention two names: Srabani Sen who stood third and Mritunjoy Manna who stood fifth in the BA final Exam held by Calcutta University. We have a very rich seminar library.  We also arrange educational tour for our student every year. </span></td>
            </tr>
            <tr>
            ...
            <tr>
              <td width="44%" align="left" valign="top"><p class="style16"> <strong>Dr. Dhirendra Kumar Das</strong> </p>
                <p class="style16">&nbsp;</p>
                <p class="style16"> Associate Professor </p>
                <p class="style16"> Ph. No. 09831836753 </p>
                <p class="style16"> <strong>Research interest and Publication:</strong> </p>
                <p class="style16"> Secondary Suffixes in Sanskrit Grammar; Sanskrit Book Dept. </p>
                <p class="style16"> Bhādiprakaraņam (Siddhanta Kumudini); Sanskrit Book Depot. </p>
                <p class="style16">&nbsp;</p>
                <p class="style16"> <strong>Dr. Devayani Halder</strong> </p>
                <p class="style16">&nbsp;</p>
                <p class="style16"> Assistant Professor   </p>
                <p class="style16"> Ph. No. (033)22655601 (R); 09231586889 (M) </p>
                <p class="style16"> <strong>Research Interest</strong> <strong>and Publication :</strong></p>
                <p class="style16"> A study of Soma Sacrifices in the Asvatayana Śrauta Sūtra; Sanskrit Book Depot. </p>
                </td>
              <td width="56%" align="left" valign="top"><p class="style18"> Dr. Sutapa Bhattacharya </p>
                <p class="style16">&nbsp;</p>
                <p class="style16"> Associate Professor </p>
                <p class="style16"> Ph. No. (033)24063437 (R) , 09432094424 (M) </p>
                <p class="style16"> <strong>Research Interest</strong> <strong>and Publication :</strong></p>
                <p class="style16"> Publication: Laghukaumudi; Sanskrit Book Depot. </p>
                <p class="style16">&nbsp;</p>
