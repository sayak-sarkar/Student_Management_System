      ...
      <tr>
        <td align="left" valign="top"><form id="form1" name="form1" method="post" action="">
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              <td height="25" colspan="2" align="left" valign="middle"><span class="style15">Department of Bio-Chemistry</span></td>
            </tr>
            <tr>
            ...
            <tr>
              <td height="25" colspan="2" align="left" valign="middle"> <span class="style15">Faculty and their research interest </span></td>
            </tr>
            <tr>
              <td height="10" colspan="2">&nbsp;</td>
            </tr>
            <tr>
              <td width="98%" align="left" valign="top"><p class="style16"> <strong>Dr. Kakali Roy</strong></p>
                <p class="style16"><br />
                  Lecturer (Contractul)<br />
                  Ph. No : 94332-93662<br />
                  <strong>Research Interest :</strong><br />
                  •	Clarification of Fruit juice like lemon, Lime and watermelon through Ultra filtration (UF) membrane of different molecular weight cut-off (MWCO). Compared to the conventional filtration process, membrane clarification process provides simpler operation, better separation and higher juice yield.<br />
                  <br />
                  •	Variation of flux through the membrane pressure and time.<br />
                  <br />
                  •	Feasibility of UF membrane clarification of fruit juice for removal of starch was compared against the conventional method of starch reduction in juice by enzyme treatment.<br />
                  <br />
                  •	Non-enzymatic browning reactions in membrane clarified lime juice was studies by the measurement of activation energy value with the help of Arrhenius equation.<br />
                  <br />
                  •	A model has been proposed which correlates observed rejection coefficient with tans membrane pressure drop and cross flow velocity over the membrane surface. The model could adequately account for the process of clarification of watermelon juice through the UF unit considering all types of fouling phenomena likely to be encountered in such membrane modules.<br />
                  <br />
                  •	Extraction of natural colorants from fruits and vegetables like beetroot, tomato, watermelon, blackberry and purification by ultra filtration.<br />
                  <br />
                  •	The natural colorants are concentrated and applied to sweetmeat variety.<br />
                  Such products, although will cost dearer, can pass on the beneficial effects of natural colorant to the consumer and found to be a potential alternative to the synthetic food colorant. </p></td>
              <td width="2%" align="left" valign="top"><p>&nbsp;</p>
                </td>
            </tr>
            <tr>
