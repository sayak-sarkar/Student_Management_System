<%
	option explicit
	dim cn,rs,subject,coursetype,quota,cast,marks,age,rs1,t
	...
	set rs=cn.execute("update criteria set marks=('"& request.form("marks") &"'),coursetype=('"& request.form("coursetype") &"'),quota=('"& request.form("quota") &"'),cast=('"& cast &"'),age=('"& age &"') where subject=('"& request.form("subject") &"') ")
