		...
		<ul class="menu">
			...
			<li><a href="#"><span>Reports</span></a>
				<div><ul>
					...
					<li><a href="../pages/seats filled up.asp"><span>Seats Filled Up</span></a></li>
      ...
      <tr>
        <td align="left" valign="top"><form id="form1" name="form" method="post" action="">
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              <td height="25" colspan="2" align="left" valign="middle"><span class="style15">College Location</span></td>
            </tr>
            <tr>
              <td height="10" colspan="2" align="left" valign="top">&nbsp;</td>
            </tr>
            <tr>
              <td colspan="2" align="left" valign="top"><div align="center"><img src="../image/map.jpg" width="673" height="585" /></div></td>
            </tr>
            <tr>
