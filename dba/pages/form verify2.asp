...
function sure()
{
    if(navigator.appName=="Microsoft Internet Explorer")
     {
       window.open('../pages/demo11.asp','_parent');      //javascript to open html page in same tab
       //window.close();
...
function sure2()
{
    if(navigator.appName=="Microsoft Internet Explorer")
     {
       window.open('../pages/demo12.asp','_parent');      //javascript to open html page in same tab
       //window.close();
       //window.open("index.asp"); 
     }
     else
            ...
            <tr>
              ...
              <td height="25" colspan="4" align="left" valign="top" class="style60"><div align="center">
                ...
                <label>
                  ...
                  <div align="center">
                    <input type="button" name="ACCEPT" id="YES" value="ACCEPT" onclick="sure()"/>
                    </div>
                  </label>
              </div>
              ...
              <td height="10" colspan="3" align="left" valign="top" class="style60">
                <div align="right"></div>
                <input type="button" name="REJECT" id="REJECT" value="REJECT" onclick="sure2()"/></td>
