		...
		<ul class="menu">
			...
			<li><a href="#"><span>Reports</span></a>
				<div><ul>
					...
					<li><a href="../pages/admission.asp" class="parent"><span>Student Taken Admission</span></a></li>
      ...
      <tr>
        <td align="left" valign="top"><form id="form1" name="form1" method="post" action="">
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              <td height="25" colspan="3" align="left" valign="middle"><span class="style15">Continuing Education</span></td>
            </tr>
            <tr>
              <td height="10" colspan="3" align="left" valign="top">&nbsp;</td>
            </tr>
            <tr>
              <td height="10" colspan="3" align="left" valign="top"><p class="style16"> <em><strong>Center for Continuing Education of Vivekananda College</strong></em><br />
                  <br />
                  1. Distance Learning Post Graduate Courses in Zoology, Environmental Science, Mathematics, History and Bengali of<em>Vidyasagar University</em>.<br />
                  <em>Co-ordinator: </em>Dr. Tapan Kumar Poddar, Principal Vivekananda College.<br />
                  <br />
                  Phone No.:<br />
                  91-33-24976824<br />
                  91-33-24976834<br />
                  <br />
                  2. Professional Courses in collaboration with <em>Indira Gandhi National Open University (IGNOU): </em><br />
                  i) M.Com<br />
                  ii) Post graduate Diploma in rural development<br />
                  iii) Post Graduate Diploma in Journalism and Mass Communication<br />
                  iv) Master of Arts (Social Work) [MSW]<br />
                  <br />
                  <em>Co-ordinator: </em>Dr. Atanu Thakur.<br />
                  <br />
                  Phone No.:<br />
                  91-33-24976824<br />
                  91-33-24976834<br />
