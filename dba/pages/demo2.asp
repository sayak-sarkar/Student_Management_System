<%
	...
	d=request.form("dbapassword")
	
	set rs=cn.execute("select * from login")
	set rs2=cn.execute("select * from secret") 

	If rs2.fields("dbapassword")=d Then
 
        set rs=cn.execute("insert into login values('"& u &"','"& p &"')")
	Else
        response.write("<script>")
	  response.write("window.open('../pages/demo4.asp','_self')")
        response.write("</script>")
	End If
            ...
            <tr>
              ...
              <td height="25" colspan="2" align="left" valign="middle"><div align="center" class="style24">
                <div align="left" class="style25">
                  <div align="left">SUCCESSFULLY REGISTERED!!!!!!</div>
                </div>
