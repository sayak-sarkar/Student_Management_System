...
function sure()
{
  if(form.studid.value==0 && form.formno.value==0)
  {
    alert("Please select student id or form nnumber");
    form.studid.focus();
  }
  else
  {
...
<table width="960" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
		...
		<ul class="menu">
			...
			<li><a href="#"><span>Form</span></a>
				<div><ul>
						<li><a href="#"><span>Delete Form</span></a></li>
      ...
      <tr>
        <td align="left" valign="top"><form id="form1" name="form" method="post" action="../pages/demo5.asp">
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              <td width="27%" height="10" align="left" valign="top">&nbsp;</td>
              <td width="26%" height="25" align="left" valign="middle"><div align="center" class="style24">
                <div align="left" class="style25">STUDENT ID</div>
              </div></td>
              <td width="35%" height="10" align="left" valign="middle"><div align="center" class="style24">
                <div align="left">
                  <label></label>
                  <label>
            ...
            <tr>
              <td height="10" colspan="4" align="left" valign="top"><div align="center">
                <label>
                <input type="button" name="SHOW" id="SHOW" value="DELETE" onclick="sure()"/>
                </label>
              </div></td>
            </tr>
            <tr>
