<%
	...
	u=request.form("studid")
	d=12345
		
	set rs=cn.execute("select * from form")
	set rs2=cn.execute("delete from temp")
	set rs2=cn.execute("insert into temp values('"& u &"','"& d &"')") 
	set rs2=cn.execute("select * from temp")
	
	while not rs.eof = true
        If u=rs.fields("studid") Then
          set rs2=cn.execute("delete from form where studid=('"& rs2.fields("studid") &"')")
	    set rs2=cn.execute("delete from temp")
	  End If
	  rs.movenext
      wend
            ...
            <tr>
              ...
              <td height="25" colspan="2" align="left" valign="middle"><div align="center" class="style24">
                <div align="left" class="style25">
                  <div align="left">SUCCESSFULLY DELETED!!!!!!</div>
                </div>
