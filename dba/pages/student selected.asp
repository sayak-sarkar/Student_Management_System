<%
	...
	set rs=cn.execute("select * from form,student,subject,dd where form.studid=student.studid and form.studid=subject.studid and form.studid=dd.studid and form.formaccepted=1 and ddaccepted=1")
